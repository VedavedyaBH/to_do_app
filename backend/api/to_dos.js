...
to_dos.get('/api/to_do/getTodo', verifyToken, use(to_doController.getTo_dos_byId))
to_dos.put('/api/to_do/getTodo', verifyToken, use(to_doController.updateTo_doById))
to_dos.delete('/api/to_do/getTodo', verifyToken, use(to_doController.deleteto_doById))
